...
//    { {},0,0,0,0,0,0,0,0,     eSourceFlyByWire,eUDP, "192.168.1.108", MYIP_FLYBYWIRE_PORT_1}, //Phil AlienWare PC
    ...
    //{ {},0,0,0,0,0,0,0,0,     eSourceMAVLink,eUDP, "192.168.1.109", MYIP_QGROUND_CONTROL_UDP_PORT},  // UDB MAV Link stream
    { {},0,0,0,0,0,0,0,0,     eSourceMAVLink,eTCP, NULL, MYIP_DROID_PLANNER},  // UDB MAV Link stream
    //{ {},0,0,0,0,0,0,0,0,     eSourceMAVLink,eTCP, NULL, 44},  // UDB MAV Link stream
    ...
    { {},0,0,0,0,0,0,0,0,       eSourceXPlane,eUDP, "192.168.1.109", MYIP_XPLANE_UDP_PORT_1},
    //{ {},0,0,0,0,0,0,0,0,       eSourceXPlane,eUDP, "192.168.1.100", MYIP_XPLANE_UDP_PORT_1},
    //{ {},0,0,0,0,0,0,0,0,       eSourceXPlane,eUDP, "crashandburn.no-ip.org", MYIP_XPLANE_UDP_PORT_1},
    #endif

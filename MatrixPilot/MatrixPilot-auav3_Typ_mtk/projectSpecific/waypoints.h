...
const struct waypointDef waypoints[] = {
	{ { 30, -7, 3 } , F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 1
	{ { 100, -28, 3 } , F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 2
	...
	{ { -71, 22, 3 } , F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 6
	{ { -27, 9, 3 } , F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 7
};

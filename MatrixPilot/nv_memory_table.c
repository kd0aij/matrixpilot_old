...
const mavlink_parameter_block    mavlink_parameter_blocks[] = {
    ...
    { DATA_HANDLE_TRIM_CALIB , 8 , 6 , DS_LOAD_AT_STARTUP | DS_LOAD_AT_REBOOT | DS_STORE_CALIB , &udb_skip_radio_trim },
    { DATA_HANDLE_IMU_CALIB , 14 , 7 , DS_LOAD_AT_REBOOT | DS_STORE_CALIB , &udb_skip_imu_calibration },
    };

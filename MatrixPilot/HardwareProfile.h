...
#define LED_IP_ALIVE				LED_ORANGE  // undefine this to not use it
  ...
  #if (NETWORK_INTERFACE == NETWORK_INTERFACE_ETHERNET_ENC624J600) // UAV3_BOARD
  ...
  #elif (NETWORK_INTERFACE == NETWORK_INTERFACE_ETHERNET_ENC28J60) // UAV3_BOARD
  ...
  #elif (NETWORK_INTERFACE == NETWORK_INTERFACE_WIFI_MRF24WG) // UAV3_BOARD
  ...
  #if (NETWORK_INTERFACE == NETWORK_INTERFACE_ETHERNET_ENC624J600) // UDB4_BOARD | UDB5_BOARD
	#define ENC100_INTERFACE_MODE   (0) // 0 == SPI
  ...
  #elif (NETWORK_INTERFACE == NETWORK_INTERFACE_ETHERNET_ENC28J60) // UDB4_BOARD | UDB5_BOARD
  ...
  #elif (NETWORK_INTERFACE == NETWORK_INTERFACE_WIFI_MRF24WG) // UDB4_BOARD | UDB5_BOARD

...
// Common data rates
#define 	MAVLINK_RATE_RC_CHAN		8 	/* RC_CHANNELS_SCALED, RC_CHANNELS_RAW, SERVO_OUTPUT_RAW | */
#define 	MAVLINK_RATE_IMU_RAW		40	/* ATTITUDE_CONTROLLER_OUTPUT, POSITION_CONTROLLER_OUTPUT, NAV_CONTROLLER_OUTPUT. | */
#define 	MAVLINK_RATE_POSITION		40	/* LOCAL_POSITION, GLOBAL_POSITION/GLOBAL_POSITION_INT messages. | */
#define 	MAVLINK_RATE_RAW_SENSORS	8	/* IMU_RAW, GPS_RAW, GPS_STATUS packets. | */
...
#define 	MAVLINK_RATE_SUE			0	// SERIAL_UDB_EXTRA data rate on channel EXTRA1

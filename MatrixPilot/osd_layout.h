...
#define OSD_LOC_AP_MODE					OSD_LOC(USE_SMALL_FONT+1, 26)		// 1 character wide	MP and Remzibi OSD
...
#define OSD_LOC_VARIO_ARROW				OSD_LOC(1, 11)			// 1 character wide, MP only

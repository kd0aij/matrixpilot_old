...
const struct waypointDef waypoints[] = {
	{ { -740612621, 429845792, 1000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 1
	{ { -741830451, 429832145, 1000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 2
	{ { -743933306, 429770309, 1000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 3
	{ { -744853410, 428301645, 1000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 4
	{ { -744242293, 426765256, 1000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 5
	{ { -741447648, 426593594, 1000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 6
	{ { -739737901, 427179068, 1000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 7
	{ { -739415930, 428348142, 1000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 8
	{ { -739157151, 428741399, 1000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 9
};

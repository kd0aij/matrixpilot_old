...
const struct waypointDef waypoints[] = {
	{ { -739057844, 428931707, 600 } , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 1
	{ { -739600294, 428924160, 600 } , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 2
};

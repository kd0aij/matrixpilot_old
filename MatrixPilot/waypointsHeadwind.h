...
const struct waypointDef waypoints[] = {
	{ { -739225215, 428638768, 1000 } , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 1
//	{ { -739195861, 431222366, 1000 } , F_ABSOLUTE + F_CROSS_TRACK, CAM_VIEW_LAUNCH } , //Waypoint 2
};

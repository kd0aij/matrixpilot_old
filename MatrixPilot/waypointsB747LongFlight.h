...
const struct waypointDef waypoints[] = {
	{ { -740612621, 429845792, 2000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 1
	{ { -761332902, 430352781, 2000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 2
	{ { -761655623, 428579937, 2000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 3
	{ { -740506942, 427421171, 2000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 4
	{ { -739415930, 428348141, 2000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 5
	{ { -739157151, 428741399, 2000 } , F_ABSOLUTE , CAM_VIEW_LAUNCH } , //Waypoint 6
};

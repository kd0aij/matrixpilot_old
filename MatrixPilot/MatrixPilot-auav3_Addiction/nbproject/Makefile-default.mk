...
${OBJECTDIR}/_ext/1658199856/uart.o: ../../libCommon/uart.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/1658199856 
	@${RM} ${OBJECTDIR}/_ext/1658199856/uart.o.d 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../../libCommon/uart.c  -o ${OBJECTDIR}/_ext/1658199856/uart.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1658199856/uart.o.d"        -g -omf=elf -legacy-libc -mlarge-code -mlarge-data -mconst-in-code -O0 -I"../MatrixPilot-auav3_Addiction" -I"../../MAVLink/include" -I"../../libUDB" -I"../../libDCM" -I"../../MAVLink/include/common" -I"../../MAVLink/include/matrixpilot" -I"../../MatrixPilot" -DAUAV3 -msmart-io=1 -Wall -msfr-warn=on
	@${FIXDEPS} "${OBJECTDIR}/_ext/1658199856/uart.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 

...
const struct waypointDef waypoints[] = {
	{ { -739225599, 428639075, 500 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 1
	{ { -738836677, 429208957, 1000 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 2
	{ { -736297809, 429870776, 1500 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 3
	{ { -736833391, 428583578, 2000 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 4
	{ { -737293442, 427390914, 2000 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 5
	...
	{ { -739131722, 423738332, 2000 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 8
	{ { -739873513, 422670418, 2000 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 9
	...
	{ { -743994139, 420125705, 2000 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 13
	{ { -745587158, 420492926, 2000 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 14
	{ { -746685790, 420778395, 2000 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 15
	{ { -748333738, 421226731, 2000 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 16
	{ { -749652098, 421796881, 1800 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 17
	{ { -750311279, 423220010, 1600 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 18
	{ { -749871825, 424639928, 1400 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 19
	{ { -748718261, 425449866, 1200 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 20
	{ { -747070312, 425894885, 1000 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 21
	{ { -745697020, 426501218, 800 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 22
	{ { -743939207, 426945485, 600 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 23
	{ { -742373656, 427228037, 400 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 24
	{ { -740451049, 427510459, 200 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 25
	{ { -739340399, 428467719, 0 } , F_ABSOLUTE  , CAM_VIEW_LAUNCH } , //Waypoint 26
	{ { -739157151, 428741399, 0 } , F_ABSOLUTE  + F_LAND , CAM_VIEW_LAUNCH } , //Waypoint 27
};

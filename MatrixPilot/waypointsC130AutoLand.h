...
const struct waypointDef waypoints[] = {
	{ { -739150285, 428752093, 600 } , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 1
	{ { -738670920, 428573431, 600 } , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 2
	{ { -739321517, 427381872, 350 } , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 3
	{ { -739872550, 427652251, 240 } , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 4
	{ { -739292012, 428538509, -50 } , F_ABSOLUTE + F_CROSS_TRACK , CAM_VIEW_LAUNCH } , //Waypoint 5
	{ { -739210795, 428661353, 800 } , F_ABSOLUTE + F_CROSS_TRACK + F_LAND , CAM_VIEW_LAUNCH } , //Waypoint 6
	{ { -739150285, 428752093, 800 } , F_ABSOLUTE + F_CROSS_TRACK + F_LAND , CAM_VIEW_LAUNCH } , //Waypoint 7
};

...
enum MAV_CMD
{
	...
	MAV_CMD_PREFLIGHT_STORAGE_ADVANCED=243, /* Request storage of different parameter values and logs. This command will be only accepted if in pre-flight mode. |Parameter storage: Action defined by MAV_PREFLIGHT_STORAGE_ACTION| Mission storage: Action defined by MAV_PREFLIGHT_STORAGE_ACTION| Empty| Empty| Empty| Empty| Reference index for storage actions on specific parameter items or sets|  */

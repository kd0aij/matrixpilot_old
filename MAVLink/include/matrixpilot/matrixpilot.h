...
#include "./mavlink_msg_flexifunction_statistics.h"
#include "./mavlink_msg_flexifunction_sizes.h"
#include "./mavlink_msg_flexifunction_sizes_ack.h"

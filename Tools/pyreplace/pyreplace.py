...
#                                if(outline.find("unsigned int") >= 0):
#                                    print("found line with unsigned int")  
#                                    if(filepath.find("airframe.h") >= 0):
#                                        print("found airfram.h with unsigned int")
#                                    if(outline.find(cmpstr) >= 0):
#                                        print("found line with unsigned int that fits cmpstr")                                                                      
